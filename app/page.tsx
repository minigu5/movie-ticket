    ...
    for (let i = 0; i < emailPayloads.length; i += CHUNK_SIZE) {
      ...
      try {
        await fetch('/api/group-invite', {
          method: 'POST',
          body: JSON.stringify({ members: chunk, leaderName, movieTitle: movieInfo.title, movieDate: movieInfo.date_string, venue: movieInfo.venue, posterUrl: movieInfo.poster_url, groupId, baseUrl })
        });
