        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
          <div className="bg-gray-800 p-6 md:p-8 rounded-2xl w-full max-w-md border border-gray-600 shadow-2xl">
            ...
            <div className="flex gap-4 mt-8">
              ...
              <button onClick={handleSubmit} className="flex-1 py-3 bg-blue-600 hover:bg-blue-500 rounded-lg text-white font-bold transition-colors">예매하기</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-[60]">
          <div className="bg-gray-800 p-6 md:p-8 rounded-2xl w-full max-w-sm border border-yellow-600 shadow-2xl text-center">
            ...
            <div className="bg-gray-700 rounded-lg p-4 text-left mb-6">
              <p className="text-sm text-gray-300 mb-1">결제 금액: <span className="text-white font-bold text-lg">2,500원</span></p>
              <p className="text-sm text-gray-300">입금자명: <span className="text-blue-400 font-bold">{formData.studentId} {formData.name}</span></p>
              <p className="text-xs text-gray-400 mt-2">* 입금자명이 다르면 승인되지 않습니다.</p>
            </div>
