    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6 md:p-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
          ...
          <p className="text-sm text-slate-500 mb-8">시행일: 2026년 8월 20일 · 최종 개정일: 2026년 8월 28일</p>
          ...
          <section className="mb-8">
            <h2 className="text-base font-bold text-indigo-400 border-b border-slate-800 pb-2 mb-4">3. 제3자 제공 및 국외 이전</h2>
            <p className="text-sm text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-base font-bold text-indigo-400 border-b border-slate-800 pb-2 mb-4">4. 정보주체의 권리와 행사 방법</h2>
            <p className="text-sm text-slate-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-base font-bold text-indigo-400 border-b border-slate-800 pb-2 mb-4">5. 개인정보의 안전성 확보 조치</h2>
            <ul className="mt-1 space-y-1.5 text-sm text-slate-400 list-disc list-inside">
          ...
          <section>
            <h2 className="text-base font-bold text-indigo-400 border-b border-slate-800 pb-2 mb-4">6. 개인정보 보호책임자</h2>
            <p className="text-sm text-slate-300 leading-relaxed">
              개인정보 처리에 관한 문의, 불만 처리, 권리 행사 접수는 아래 개인정보 보호책임자에게
              연락 주십시오.
            </p>
            <p className="mt-2 text-sm text-slate-400">
              <span className="font-semibold text-slate-300 mr-1.5">성명</span>신민규
            </p>
            <p className="mt-1.5 text-sm text-slate-400">
              <span className="font-semibold text-slate-300 mr-1.5">직책</span>개발자 (개인정보 보호책임자 겸임)
            </p>
            <p className="mt-1.5 text-sm text-slate-400">
